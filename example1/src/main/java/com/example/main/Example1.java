...
public class Example1 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("Vehicle2 name from Spring Context is: " + veh3.getName());
        ...
        * */
        ...
        Boolean bol = context.getBean("bool", Boolean.class);
        System.out.println("Boolean value is "+bol);
        Boolean bol2 = context.getBean("bool2",Boolean.class);
